...
/*************************Inisialisasi Serial Communication to NodeMCU*****************************************/
...
const float ktcg = 0.019580104; // Koefisien Tachogenerator
const float pi = 22/7;
int tacho_rpm;
int motor_rpm;
int tacho_rad;
...
void setup() {
  ...
  /****************************************setup Serial Communication to NodeMCU********************************************************************/
...
void kirim_NodeMCU(){
  ...
  ArduinoSerial.print(hour()); ArduinoSerial.print('\n');
  ArduinoSerial.print(minute()); ArduinoSerial.print('\n');
  ArduinoSerial.print(second()); ArduinoSerial.print('\n');
  ArduinoSerial.print(day()); ArduinoSerial.print('\n');
  ArduinoSerial.print(month()); ArduinoSerial.print('\n');
  ArduinoSerial.print(year()); ArduinoSerial.print('\n');
  ArduinoSerial.print(flat == TinyGPS::GPS_INVALID_F_ANGLE ? 0.0 : flat, 6); ArduinoSerial.print('\n');
  ArduinoSerial.print(flon == TinyGPS::GPS_INVALID_F_ANGLE ? 0.0 : flon, 6); ArduinoSerial.print('\n');
  
  //ArduinoSerial.print(" Suhu_bat1: "); 
  ArduinoSerial.print(sensors.getTempCByIndex(0)); ArduinoSerial.print('\n');//0 refers to the first IC on the wire
  //ArduinoSerial.print("  Suhu_bat2: "); 
  ArduinoSerial.print(sensors.getTempCByIndex(1)); ArduinoSerial.print('\n');
  //ArduinoSerial.print("  Suhu_motor: "); 
  ArduinoSerial.print(sensors.getTempCByIndex(2)); ArduinoSerial.print('\n');
  //ArduinoSerial.print("\t  V_bat1: "); 
  ArduinoSerial.print(batteryVoltage1); ArduinoSerial.print('\n');
  //ArduinoSerial.print("\t Arus dc = "); 
  ArduinoSerial.print(Amps); ArduinoSerial.print('\n');
  //ArduinoSerial.print("\t  Arus ac= "); 
  ArduinoSerial.print(total); ArduinoSerial.print('\n');
  //ArduinoSerial.print("\t  RPM motor : "); 
  ArduinoSerial.print(motor_rpm); ArduinoSerial.print('\n');
  //ArduinoSerial.print('*');
